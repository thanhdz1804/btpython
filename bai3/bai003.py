...
class QuanLyBaiXe:
    ...
    def xuat_excel(self, filename="parking_data.xlsx"):
        data = [{
            "Chủ xe": xe.chu_xe,
            "Loại xe": xe.loai_xe,
            "Biển số": xe.bien_so,
...
# Thêm một vài xe
ql_bai_xe.them_xe(Info_Xe("Xe máy", "Nguyễn Văn A", 3, "59A1-123.45"))
ql_bai_xe.them_xe(Info_Xe("Xe đạp", "Trần Thị B", 5))
ql_bai_xe.them_xe(Info_Xe("Ô tô", "Lê Văn C", 2, "51G-678.90"))
ql_bai_xe.them_xe(Info_Xe("Xe điện", "Phạm Văn D", 7))
